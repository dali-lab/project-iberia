...
We'll have to use some Terminal command line dark magic here.  Copy/paste is your friend.  
  ...
  <br>![](docs/img/square.png) 2.2)  ```git clone https://github.com/dali-lab/project-iberia.git```
  <br>![](docs/img/square.png) 2.3)  ```cd project-iberia```
...
Now you can go to [http://dali-lab.github.io/project-name](http://dali-lab.github.io/project-iberia) to see your site!
